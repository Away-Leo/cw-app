package com.cw.biz.marketproxy.app.service;

import com.cw.biz.banner.app.dto.BannerDto;
import com.cw.biz.banner.domain.entity.Banner;
import com.cw.biz.banner.domain.service.BannerDomainService;
...
@Transactional
@Service
public class MarketProxyAppService {
    ...
    public List<BannerDto> findAll(String position,String versionNo)
    {
        ...
        {
            if(versionNo!=null&&!versionNo.equalsIgnoreCase("1")){
